...
import { X, Mail, Lock, User as UserIcon, ArrowRight, Zap, ShieldCheck } from 'lucide-react';
      ...
      <div className="relative w-full max-w-md m3-card bg-white dark:bg-[#121214] p-6 shadow-2xl border border-slate-200 dark:border-zinc-800 text-slate-900 dark:text-white">
        ...
        <div className="text-center mb-6 pt-2">
          ...
          <p className="text-xs text-slate-500 dark:text-zinc-400 mt-1">
            Track fuel efficiency, mileage, and maintenance logs seamlessly.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full py-3 rounded-full bg-[#FF5200] hover:bg-[#E04800] text-white font-bold text-xs tracking-wide shadow-lg shadow-[#FF5200]/30 transition flex items-center justify-center gap-2 mt-2"
          >
        ...
        <button
          ...
          className="w-full py-3 rounded-full bg-slate-100 dark:bg-zinc-800/90 hover:bg-slate-200 dark:hover:bg-zinc-700 text-slate-800 dark:text-zinc-100 font-bold text-xs transition flex items-center justify-center gap-2 border border-slate-200 dark:border-zinc-700"
        >
          <ShieldCheck className="w-4 h-4 text-[#FF5200]" />
          <span>Proceed as Guest (Offline Mode)</span>
        </button>
